                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                <h6>Trang Phục Hè</h6>
                                <h2>Quần Áo Thu Đông</h2>
                                <p>Một nhãn hiệu chuyên tạo ra những sản phẩm thiết yếu sang trọng. Được chế tạo có đạo đức với cam kết vững chắc về chất lượng vượt trội.</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="filter__controls">
                        <li class="active" data-filter="*">Xu Hướng Mua nhiều</li>
                        <li data-filter=".new-arrivals">Đồ Mới</li>
                        <li data-filter=".hot-sales">Quần Áo sales</li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/product/product-1.jpg">
                            ...
                            <ul class="product__hover">
                                ...
                                <li>
                                    <a href="#"><img src="img/icon/compare.png" alt=""> <span>So Sánh</span></a>
                                </li>
                                <li>
