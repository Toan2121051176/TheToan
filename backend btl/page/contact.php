                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__text">
                        <div class="section-title">
                            ...
                            <p>Nếu quý khách cần tư vấn hoặc có bất cứ thắc mắc gì, T Fashison rất vui lòng được hỗ trợ bạn</p>
                        </div>
                        <ul>
                            <li>
                                <h4>Địa chỉ </h4>
                                <p>39 Phố Viên, Cổ Nhuế 2, Bắc Từ Liêm , Hà Nội <br /> Điện thoại : +84 983080347</p>
                            </li>
